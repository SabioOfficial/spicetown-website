    ...
    <div className="flex h-full flex-col gap-16 items-center justify-center">
      <div className="flex flex-row gap-16">
        ...
        <div className="flex flex-row gap-8">
          ...
          <a href="https://addons.mozilla.org/en-GB/firefox/addon/spicetown/"><img src={`./get-the-addon-fx-apr-2020.svg`} className="w-auto h-12"></img></a>
        </div>
      </div>
      <div className="flex flex-row gap-16">
        <picture>
        ...
        <a href="https://github.com/SabioOfficial/spicetown/actions/workflows/build-extension-zip.yml">
          <picture>
